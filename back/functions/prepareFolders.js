...
module.exports.prepareFolders = () => {
  ...
  if (!fs.existsSync(__dirname + "/../data/files/image"))
    fs.mkdirSync(__dirname + "/../data/files/image");
  if (!fs.existsSync(__dirname + "/../data/files/stl"))
    fs.mkdirSync(__dirname + "/../data/files/stl");
