                ...
                <div className="space-y-1">
                  ...
                  <div className="mt-1">
                    <input
                      ...
                      required
                      className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-brand-magenta focus:border-brand-magenta sm:text-sm"
                    />
                  </div>
                </div>
                <div className="space-y-1">
